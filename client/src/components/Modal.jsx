...
export default function Modal(props) {
  ...
  return (
    <>
      <button
        className="bg-indigo-100 text-indigo-800 active:bg-indigo-200 font-bold text-sm py-3 md:py-4 lg:py-4 px-4 rounded-lg outline-none focus:outline-none mr-2 mb-2 ease-linear transition-all duration-150"
        type="button"
